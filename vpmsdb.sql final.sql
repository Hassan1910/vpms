...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2025 at 09:56 PM
...
CREATE TABLE `feedback` (
  ...
  `user_viewed` tinyint(1) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `notification_preferences` (
  ...
  `SoundNotifications` tinyint(1) DEFAULT 1,
  `FeedbackNotifications` tinyint(1) DEFAULT 1,
  `ReplyNotifications` tinyint(1) DEFAULT 1,
...
CREATE TABLE `tblfeedback_replies` (
  `ID` int(10) NOT NULL,
...
(9, 'Hassan', 'Adan', 757489214, 'chizicheza@gmail.com', '$2y$10$wSIGcrAGaSUHgNR7n11IGedOE0zyF0H8m4zG23SzEVIIY3wuGcYZq', '2025-08-07 03:58:44');
...
ALTER TABLE `notification_preferences`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `unique_user_type` (`UserID`,`UserType`);
...
--
-- Indexes for table `tblfeedback_replies`
--
ALTER TABLE `tblfeedback_replies`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `FeedbackID` (`FeedbackID`),
  ADD KEY `SenderType` (`SenderType`),
  ADD KEY `IsRead` (`IsRead`),
  ADD KEY `idx_replies_feedback_sender` (`FeedbackID`,`SenderType`),
  ADD KEY `idx_replies_unread` (`IsRead`,`SenderType`);
...
--
-- AUTO_INCREMENT for table `tblfeedback_replies`
--
ALTER TABLE `tblfeedback_replies`
...
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tblregusers` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `feedback_replies`
--
ALTER TABLE `feedback_replies`
  ADD CONSTRAINT `feedback_replies_ibfk_1` FOREIGN KEY (`feedback_id`) REFERENCES `feedback` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `tblfeedback_replies`
--
ALTER TABLE `tblfeedback_replies`
  ADD CONSTRAINT `tblfeedback_replies_ibfk_1` FOREIGN KEY (`FeedbackID`) REFERENCES `tblfeedback` (`ID`) ON DELETE CASCADE;
COMMIT;
